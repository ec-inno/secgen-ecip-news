        ...
        <div className="ecl-row ecl-u-mt-l">
          ...
          <div className="ecl-col-12 ecl-col-sm-9">
            ...
            <p className="ecl-u-type-paragraph">
              ...
              come together around an issue close to their heart with a view to
            ...
            <p className="ecl-u-type-paragraph">
              ...
              old, except in Austria &amp; Malta where the voting age is 16, and
            ...
            <p className="ecl-u-type-paragraph">
              ...
              citizens. Once the registration is confirmed, organisers have one
            ...
            <p className="ecl-u-type-paragraph">
              All EU citizens (nationals of a member state) old enough to vote*
              in the European Parliament elections (18 years old, except in
              Austria &amp; Malta where the voting age is 16, and Greece where
              the voting age is 17) can sign a citizens' initiative.
            </p>
            <p className="ecl-u-type-paragraph">
              To give their support to an initiative, citizens have to fill in a
              specific statement of support form provided by the organisers, on
              paper or online. It is not possible to sign up to an initiative on
              this website.
            </p>
            <p className="ecl-u-type-paragraph">
              <em>
            ...
            <ul className="ecl-unordered-list">
              <li className="ecl-unordered-list__item">
                Commission representatives will meet the organisers so they can
                explain in detail the issues raised in their initiative
              </li>
              <li className="ecl-unordered-list__item">
              ...
              <li className="ecl-unordered-list__item">
                ...
                action it will propose in response to the citizens' initiative,
                if any, and the reasons for doing or not doing so.
              </li>
            </ul>
            <p></p>
            <p className="ecl-u-type-paragraph">
              The response, which will take the form of a communication, will be
              formally adopted by the College of Commissioners and published in
            ...
            <p className="ecl-u-type-paragraph">
              ...
              legislative proposal, the normal legislative procedure kicks off:
              the Commission proposal is submitted to the legislator (generally
              the European Parliament and the Council or in some cases only the
              Council) and, if adopted, it becomes law.
            </p>
            <p className="ecl-u-type-paragraph">
              <a href="#" className="ecl-link">
                Lear more here
