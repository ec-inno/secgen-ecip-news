!(function(e, t) {
  ...
  (function(e) {
        ...
        u = {
          adapter:
            ...
            '[object process]' === Object.prototype.toString.call(process)
              ? (a = r(24))
              : 'undefined' != typeof XMLHttpRequest && (a = r(38)),
            a),
          transformRequest: [
            function(e, t) {
              return (
    ...
    function(e, t, r) {
      ...
      var i = async (
        e = 'https://ec.europa.eu/citizens-initiative/services/initiative'
      ) => {
        const t = await o.a.get(`${e}/get/all`);
        return await Promise.all(
          t.data.initiative.map(async t => {
            const r = t['@year'],
              n = t['@number'];
            if (r && n) {
              const i = await o.a.get(`${e}/details/${r}/${n}`),
                { initiative: a } = i.data;
              return (function(e) {
      ...
      const a = async () => {
        try {
          const e = await i();
          return { statusCode: 200, body: JSON.stringify({ initiatives: e }) };
        } catch (e) {
          return (
            console.log(e),
    ...
    function(e, t, r) {
      ...
      e.exports = function(e) {
        return new Promise(function(t, r) {
          ...
          var E = m.test(O),
            F = E ? e.httpsAgent : e.httpAgent,
            _ = {
              path: s(w.path, e.params, e.paramsSerializer).replace(/^\?/, ''),
          ...
          e.socketPath
            ...
            : ((_.hostname = w.hostname), (_.port = w.port));
          var j,
            A = e.proxy;
          if (!A && !1 !== A) {
            var S = O.slice(0, -1) + '_proxy',
              B = process.env[S] || process.env[S.toUpperCase()];
            if (B) {
              var T = f.parse(B),
              ...
              if (N && ((A = { host: T.hostname, port: T.port }), T.auth)) {
                var q = T.auth.split(':');
                A.auth = { username: q[0], password: q[1] };
              }
            }
          }
          if (
            ...
            ((_.hostname = A.host),
            (_.host = A.host),
            (_.headers.host = w.hostname + (w.port ? ':' + w.port : '')),
            (_.port = A.port),
            (_.path =
              O + '//' + w.hostname + (w.port ? ':' + w.port : '') + _.path),
            A.auth)
          ) {
            var L = Buffer.from(
            ...
            _.headers['Proxy-Authorization'] = 'Basic ' + L;
          }
          var P = E && (!A || m.test(A.protocol));
          e.transport
            ? (j = e.transport)
            : 0 === e.maxRedirects
            ? (j = P ? a : i)
